...
# Full reconciliation creates host-level migration-* rollback snapshots. Once the
# new backend, maintenance service and Host Agent have converged successfully,
# retain only the newest three automatic migration snapshots.
