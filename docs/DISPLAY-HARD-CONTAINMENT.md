...
Renderer revision `dynamic-fit-20260921-4` makes containment and dynamic space use joint invariants.
...
The receiver HTML uses the same `dynamic-fit-20260921-4` cache key for the layout module and stylesheet. Every renderer behavior change must bump this key.
...
Expected revision: `dynamic-fit-20260921-4`.
