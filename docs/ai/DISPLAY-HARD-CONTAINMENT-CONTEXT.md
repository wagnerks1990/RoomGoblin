...
Renderer revision `dynamic-fit-20260921-6` treats title, subtitle, body, and timer as dynamic objects. Do not reintroduce fixed title/subtitle/body/timer bands.
