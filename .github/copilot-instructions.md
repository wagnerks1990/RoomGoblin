...
- RoomGoblin supports upstream/OEM Veyon configuration and upstream/OEM add-ons only. Do not reintroduce custom/community Veyon plugins, experimental browser adapters, native pilot builders, local Veyon analysis services, or endpoint command-shell bridges.
