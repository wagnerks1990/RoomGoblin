...
Renderer revision `dynamic-fit-20260921-6` replaces the old fixed-band sizing model.
...
Confirm `revision` is `dynamic-fit-20260921-6`, `dynamic` is true, active regions do not overlap, and title/body text remains fully contained.
