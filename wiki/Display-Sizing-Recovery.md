...
Renderer revision `dynamic-fit-20260921-5` replaces the old fixed-band sizing model.
...
Confirm `revision` is `dynamic-fit-20260921-5`, `dynamic` is true, active regions do not overlap, and title/body text remains fully contained.
