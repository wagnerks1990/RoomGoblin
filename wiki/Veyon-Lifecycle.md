...
reported rather than selecting an arbitrary component. Debian/Ubuntu package suffixes such as `4.11.3.0-ubuntu.26.04` are normalized to `4.11.3` in the lifecycle UI. Missing inventory means
