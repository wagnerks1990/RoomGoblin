...
> **Status:** `1.0.0-alpha.84` — alpha software; production deployment remains limited to reviewed, backed-up `amd64` installations. Recovery passphrases require loopback or HTTPS through a same-host proxy even when ordinary administration uses trusted-LAN HTTP.
