...
if old not in s: raise SystemExit('assertAutomationConflicts marker not found')
...
if old_route not in s: raise SystemExit('automation update conflict marker not found')
